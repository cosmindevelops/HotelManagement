...
GO
/*
The type for column Description in table [dbo].[RoomTypes] is currently  NCHAR (2000) NOT NULL but is being changed to  NVARCHAR (200) NOT NULL. Data loss could occur and deployment may fail if the column contains data that is incompatible with type  NVARCHAR (200) NOT NULL.
*/
...
GO
ALTER TABLE [dbo].[RoomTypes] ALTER COLUMN [Description] NVARCHAR (200) NOT NULL;
